...
export const CryptoCurrencyListRow = ({id, name, rank, symbol, price_usd, percent_change_1h, csupply, nameid,}: crypto) => {

    

    return (
        <Link to={`detail/${id}`} className={styles.currency_row}>
